...
class LoaderTestCase(TestCase):
    ...
    def test_simple_hour_string_parses(self):
        ...
        self.assertListEqual(parsed, parsed_list)  # for simple hours these should be the same
    ...
    def test_full_line_hour_parses(self):
        ...
        multi_line_hours = ("Mon-Wed 5 pm - 12:30 am  / Thu-Fri 5 pm - 1:30 am  /"
        ...
        self.assertListEqual(
            parsed,
            [
                {'weekday': 0, 'opens_at': time(17, 0), 'closes_at': time(0, 30)},
                {'weekday': 1, 'opens_at': time(17, 0), 'closes_at': time(0, 30)},
                {'weekday': 2, 'opens_at': time(17, 0), 'closes_at': time(0, 30)},
                {'weekday': 3, 'opens_at': time(17, 0), 'closes_at': time(1, 30)},
                {'weekday': 4, 'opens_at': time(17, 0), 'closes_at': time(1, 30)},
                {'weekday': 5, 'opens_at': time(15, 0), 'closes_at': time(1, 30)},
